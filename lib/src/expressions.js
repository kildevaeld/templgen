...
class AssignmentExpression extends Expression {
    constructor(location, name, expression, declaring) {
        super(location);
        this.name = name;
...
class TagAssignmentExpression extends Expression {
    constructor(location, expression, modifier) {
        super(location);
        this.expression = expression;
        this.modifier = modifier;
        this.nodeType = types_1.Token.Tag;
        this.tagType = types_1.TagType.Assignment;
    }
}
exports.TagAssignmentExpression = TagAssignmentExpression;
...
exports.TagExpression = TagExpression;
...
function createExpression(type, position, ...args) {
    switch (type) {
        case types_1.Token.Assignment: return new AssignmentExpression(position, args[0], args[1], args[2]);
        ...
        case types_1.Token.Template: return new TemplateExpression(position, args[0]);
        ...
        case types_1.Token.Tag: {
            switch (args[0]) {
                case types_1.TagType.Assignment:
